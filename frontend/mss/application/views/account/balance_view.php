...
<div class="portlet box grey">
    ...
    <div class="portlet-body">
        ...
        <div class="input-group input-medium date date-picker " data-date=""  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
            ...
            金額 <input class="form-control" type="text" name='amount' value="">
...
<div class="portlet box grey">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-square"></i>Balance Sheet
        </div>
        <div class="actions">
            <div class="btn-group">
              ...
              <input type='hidden' name ='type' value='1'>
                ...
                <tbody>
                    ...
                    foreach ($query1->result() as $row) {
                        ...
                        ?>
                        <tr>
                        		<td><input type="checkbox" class="checkboxes" value="<?=$row->balanceid ?>" name="chk1[]"/></td>
                        	<td><a class="btn red" onClick="return check();"  href="<?= $adminurl . "balance_del" ?>/<?= $row->balanceid ?>">刪除</a></td>
                        	<td>
                                ...
                                <div class="input-group input-medium date date-picker " data-date="<?=$row->pdate;?>"  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                    <input type="text" name="pdate<?= $row->balanceid ?>" class="form-control" value="<?=$row->pdate;?>" readonly>
                                    <span class="input-group-btn">
                                    <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                    </span>
                                </div>
                        	...
                        	<td>
                        	  ...
                        	  <?
                            echo "<select class=\"form-control input-medium select2me\" name='accounttypeid$row->balanceid'>";
                            $sql = "select * from accounttype";
                        	...
                        	<td>
                        		<input class="form-control" type="text" name='amount<?= $row->balanceid ?>' value="<?=$row->amount?>">
                        		</td>
                        </tr>
                        <? 
                        	@$Assetsin+=$row->amount;
              ...
              <input type='hidden' name ='type' value='2'>
                ...
                <tbody>
                    ...
                    foreach ($query4->result() as $row) {
                        ...
                        ?>
                        <tr >
                        		<td><input class="checkboxes" type="checkbox" value="<?=$row->balanceid ?>" name="chk2[]"/></td>
                        	<td><a class="btn red" onClick="return check();"  href="<?= $adminurl . "balance_del" ?>/<?= $row->balanceid ?>">刪除</a></td>
                        <td>
                        	...
                        	<td>
                                <select class="form-control input-medium select2me" name='accounttypeid$row->balanceid'>
                        	  <?
                            $sql = "select * from accounttype";
              ...
              <input type='hidden' name ='type' value='3'>
                ...
                <tbody>
                    ...
                    foreach ($query3->result() as $row) {
                        ...
                        ?>
                        <tr class="<?= $bgColor; ?>">
                        		<td><input class="checkboxes" type="checkbox" value="<?=$row->balanceid ?>" name="chk3[]"/></td>
                        	<td><a  class="btn red" onClick="return check();"  href="<?= $adminurl . "balance_del" ?>/<?= $row->balanceid ?>">刪除</a></td>
                        	<td>
