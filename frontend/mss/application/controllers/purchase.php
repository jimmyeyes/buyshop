		...
		//	echo $ar."<br>";
			...
			if($ch==$ar){
				...
				if($type=="2"){
                    ...
                    $sql="update product set orgamount='".$row->Quantity."' where productid='".$productid."' ";
                    $query = $this -> db -> query($sql);

                    $sql="update product set Quantity=Quantity+".$amount." ,isIn='1' where productid='".$productid."' ";
                    $query = $this -> db -> query($sql);
