                    ...
                    foreach ($query4->result() as $row) {
                        ...
                        <tr class="<?= $bgColor; ?>">
                           ...
                           <td class="nCategory"><?=$row->model?>  </td>
							...
							<td class="nCategory"> <input class="form-field "    type="text" value="<?=$row->no?>"  name="no<?=$row->purchaseid ?>">  </td>	
							<td class="nCategory"> <input class="form-field "    type="text" value="<?=$row->price?>"  name="price<?=$row->purchaseid ?>">  </td>	
