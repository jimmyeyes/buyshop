...
<div id="content">
	    ...
	    <?php
            ...
            $sql="select m.*,r1.username from  productonebay m left join accounttoken r1 on m.accounttokenid=r1.accounttokenid  where m.productid = $id and r1.accounttokenid='$accounttokenid' and `on` ='1' ";
        ...
        <?
      $row=  $this -> db -> get_where('product', array('productid' => $id)) -> row();
	...
	<div  class="box themed_box">
        ...
        <div class="box-content">
            ...
            <select name="storecategory">
                ...
                foreach($query->result() as $rowv){
                    ...
                    foreach($order as $row1){
                        ...
                        <option
                            <?
                            if($row->storecategory ==$row1->CategoryID){ ?>selected<?}?>value='<?=$row1->CategoryID?>'><?=$row1->Name?></option>
                    <?}}?>
            </select>
            ...
            ?>
            <a target="_blank" href='http://cgi.sandbox.ebay.com/ws/eBayISAPI.dll?ViewItem&item=<?=$rowv->ItemID?>'>ItemID:<?=$rowv->ItemID?></a>
            ...
            <?
                ...
                <input type="text" class="form-field 10" value="<?=$row->PriceAUD?>" name="PriceAU" size="20" />
