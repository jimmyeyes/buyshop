...
l.index(g);f=m+c;c=c;var p=g.next(e.group);if(g.hasClass("active")){p.trigger("hide");c+="closed"}else{p.trigger("show");c+="open"}a&&b.cookie(f,c,{path:"/",expires:10})})})}});var a;a:{try{b.cookie("x","x",{path:"/",expires:10});b.cookie("x",null)}catch(d){a=false;break a}a=true}})(jQuery);